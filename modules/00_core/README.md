...
## Quick Links
* **Architecture:** For the theoretical foundation, see [`/docs/01_architecture.md`](../../docs/01_architecture.md).
* **Scaling:** Learn about our O(1) traversal strategy in [`/docs/02_performance-and-scaling.md`](../../docs/02_performance-and-scaling.md).
...
## Deployment
To initialize a Neo4j instance with the IDEA Core, execute the Cypher scripts in the following order (or let the seeder in our [docker-compose.yml](../../docker-compose.yml) do its job):

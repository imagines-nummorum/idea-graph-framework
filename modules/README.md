# IDEA: Modular Framework Overview

IDEA is built as a strictly modular system to ensure that the abstract **Core** remains lean and high-performing while allowing for domain-specific or feature-rich extensions.
...
* **Status:** Active (v0.9).
* **Description:** The domain-agnostic engine of IDEA.
...
The following modules are currently placeholders, representing the next phase of the IDEA implementation.
...
* **Objective:** The first domain-specific implementation of IDEA, tailored for ancient coinage.
* **Planned Features:**
...
To further expand the scope of IDEA, we are considering the following functional modules:
...
We invite researchers from all fields of visual culture to develop their own modules based on the IDEA Core. If you are interested in creating an own extension, please refer to our [CONTRIBUTING.md](../CONTRIBUTING.md) guide.
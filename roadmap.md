# IN.IDEA: Roadmap 2026

This document outlines the development milestones for the IN.IDEA framework in 2026. Following the initial release of the **IN.IDEA Core**, which serves as a domain-agnostic engine for formal analysis, our focus shifts toward domain-specific extensions, the implementation of the relational Single Source of Truth (SSoT), and the development of internal tooling.
...
* **February: Module Expansion**
  ...
  * **Release: Numismatics Module:** Providing specialized labels and properties for coin-specific data, extending the IN.IDEA Core without altering its fundamental logic.

* **February/March: Scientific Communication**
  * Submission of the foundational paper on the IN.IDEA framework to academic platforms.
...
In the second quarter, IN.IDEA transitions from a conceptual model into a functional data engineering environment.

* **April: Infrastructure Deployment**
  * Setup of the IN.IDEA test environment and API endpoints.
